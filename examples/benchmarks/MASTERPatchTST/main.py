...
def update_config_file(universe):
    """更新配置文件中的市场参数"""
    config_file = "./workflow_config_master_patchtst_Alpha158.yaml"  # 修改为PatchTST版本的配置文件
...
if __name__ == "__main__":
    ...
    with open("./workflow_config_master_patchtst_Alpha158.yaml", 'r') as f:  # 修改为PatchTST版本的配置文件
    ...
    for seed in range(0, 3):
        ...
        if not args.only_backtest:
            ...
            model.load_model(f"./model/{config['market']}master_patchtst_{seed}.pkl")  # 修改为PatchTST版本的模型文件名
