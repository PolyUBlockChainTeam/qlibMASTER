...
def update_config_file(universe):
    """更新配置文件中的市场参数"""
    config_file = "./workflow_config_master_patchtst_Multi_Scale_Alpha158.yaml"  # 修改为PatchTST多尺度版本的配置文件
...
if __name__ == "__main__":
    ...
    logger.info(f"开始运行 MASTER-PatchTST 模型 - universe: {args.universe}, only_backtest: {args.only_backtest}")
    ...
    with open("./workflow_config_master_patchtst_Multi_Scale_Alpha158.yaml", 'r') as f:  # 修改为多尺度版本的配置文件
    ...
    for seed in range(0, 3):
        ...
        if not args.only_backtest:
            ...
            model.load_model(f"./model/{config['market']}master_patchtst_Multi_Scale_{seed}.pkl")  # 修改为多尺度版本的模型文件名
